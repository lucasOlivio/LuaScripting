...
function onstart(thisEntity)
    ...
    -- Example usage:
    local moveCommand1 = commands.MoveCommand(entity, {1600.0, 0.0, 0.0}, 6, 0.2, 0.0, false)
    local moveCommand2 = commands.MoveCommand(entity, {1600.0, 1600.0, 0.0}, 6, 0.2, 0.0, false)
    local moveCommand3 = commands.MoveCommand(entity, {0.0, 1600.0, 0.0}, 6, 0.2, 0.2, true)

    
    local orientCommand1 = commands.OrientCommand(entity, {0.0, 90.0, 0.0}, 6, 0.2, 0.0, false)
    local orientCommand2 = commands.OrientCommand(entity, {90.0, 90.0, 0.0}, 6, 0.2, 0.0, false)
    local orientCommand3 = commands.OrientCommand(entity, {90.0, 0.0, 0.0}, 6, 0.2, 0.2, true)
